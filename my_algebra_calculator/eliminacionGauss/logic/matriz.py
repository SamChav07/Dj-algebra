...
class Matriz:
    ...
    def calcular_transpuesta(self):
        ...
        transpuesta = [[self.matriz[j][i] for j in range(len(self.matriz))] for i in range(len(self.matriz[0]))]
        return transpuesta  # Return the transposed matrix as a list of lists
